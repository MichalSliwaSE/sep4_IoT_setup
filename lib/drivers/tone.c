...
void play_song() {
    ...
    tone_play(NOTE_C4, NOTE_QUARTER);
    _delay_ms(NOTE_QUARTER);
    tone_play(NOTE_C4, NOTE_QUARTER);
    _delay_ms(NOTE_QUARTER);
    tone_play(NOTE_G4, NOTE_QUARTER);
    _delay_ms(NOTE_QUARTER);
    tone_play(NOTE_G4, NOTE_QUARTER);
    _delay_ms(NOTE_QUARTER);
    tone_play(NOTE_A4, NOTE_QUARTER);
    _delay_ms(NOTE_QUARTER);
    tone_play(NOTE_A4, NOTE_QUARTER);
    _delay_ms(NOTE_QUARTER);
    tone_play(NOTE_G4, NOTE_HALF);
    _delay_ms(NOTE_QUARTER);
    
    tone_play(NOTE_F4, NOTE_QUARTER);
    _delay_ms(NOTE_QUARTER);
    tone_play(NOTE_F4, NOTE_QUARTER);
    _delay_ms(NOTE_QUARTER);
    tone_play(NOTE_E4, NOTE_QUARTER);
    _delay_ms(NOTE_QUARTER);
    tone_play(NOTE_E4, NOTE_QUARTER);
    _delay_ms(NOTE_QUARTER);
    tone_play(NOTE_D4, NOTE_QUARTER);
    _delay_ms(NOTE_QUARTER);
    tone_play(NOTE_D4, NOTE_QUARTER);
    _delay_ms(NOTE_QUARTER);
    tone_play(NOTE_C4, NOTE_HALF);
    _delay_ms(NOTE_QUARTER);
